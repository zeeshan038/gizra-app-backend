...
exports.isCacheable = exports.isReplicaSafe = void 0;
/**
 ...
 */
function isReplicaSafe(meta, override) {
    if (override !== undefined)
        return override;
    if (!meta?.flags)
        return false;
    if (meta.flags.includes('write'))
        return false;
    if (meta.flags.includes('script_runner'))
        return false;
    return !meta.isKeyless;
}
exports.isReplicaSafe = isReplicaSafe;
/**
 ...
 */
function isCacheable(meta, override) {
    if (override !== undefined)
        return override;
    if (!meta?.flags)
        return false;

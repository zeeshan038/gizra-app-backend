...
class RedisSentinelMultiCommand {
    static _createCommand(command, resp) {
        ...
        return function (...args) {
            const parser = new parser_1.BasicCommandParser(this.#sentinel._keyPrefix);
            ...
            return this.addCommand(replicaSafe, redisArgs, transformReply);
        };
    }
    static _createModuleCommand(command, resp) {
        ...
        let replicaSafe;
        return function (...args) {
            const parser = new parser_1.BasicCommandParser(this._self.#sentinel._keyPrefix);
            command.parseCommand(parser, ...args);
            const redisArgs = parser.redisArgs;
            redisArgs.preserve = parser.preserve;
            replicaSafe ??= (0, command_metadata_1.isReplicaSafe)(command_metadata_1.defaultCommandMetadata.lookup(parser.commandIdentifier), command.IS_READ_ONLY);
            return this._self.addCommand(replicaSafe, redisArgs, transformReply);
        };
    }

...
class RedisClient extends node_events_1.EventEmitter {
     ...
     * @internal
     */
    async _executePipeline(commands, selectedDB, slotNumber) {
     ...
     * @internal
     */
    async _executeMulti(commands, selectedDB, slotNumber, chainId = Symbol('MULTI Chain')) {
        assertNoHimportSessionCommands(commands);
        ...
        return (0, tracing_1.trace)(tracing_1.CHANNELS.TRACE_BATCH, async () => {
            ...
            promises.push(this._self.#queue.addCommand(['EXEC'], { chainId, slotNumber }));
            this._self.#scheduleWrite();

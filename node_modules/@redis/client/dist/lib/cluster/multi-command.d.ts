...
export default class RedisClusterMultiCommand<REPLIES = []> {
    ...
    constructor(executeMulti: ClusterMultiExecute, executePipeline: ClusterMultiExecute, routing: RedisArgument | undefined, typeMapping?: TypeMapping, keyPrefix?: RedisArgument);

...
exports.getMappedNode = exports.createScriptCommand = exports.createModuleCommand = exports.createFunctionCommand = exports.createCommand = exports.clientSocketToNode = exports.mergeSentinelNodes = exports.createNodeList = exports.parseNode = void 0;
 ...
 * (see issue #3237).
 */
function mergeSentinelNodes(seedNodes, discoveredNodes) {
    const seen = new Set();
    const merged = [];
...
exports.mergeSentinelNodes = mergeSentinelNodes;
...
function createCommand(command, resp) {
    ...
    return async function (...args) {
        ...
        replicaSafe ??= (0, command_metadata_1.isReplicaSafe)(command_metadata_1.defaultCommandMetadata.lookup(parser.commandIdentifier), command.IS_READ_ONLY);
        return this._self._execute(replicaSafe, client => client._executeCommand(command, parser, this.commandOptions, transformReply));
    };
}
...
function createModuleCommand(command, resp) {
    ...
    return async function (...args) {
        ...
        command.parseCommand(parser, ...args);
        replicaSafe ??= (0, command_metadata_1.isReplicaSafe)(command_metadata_1.defaultCommandMetadata.lookup(parser.commandIdentifier), command.IS_READ_ONLY);
        return this._self._execute(replicaSafe, client => client._executeCommand(command, parser, this._self.commandOptions, transformReply));
    };
}

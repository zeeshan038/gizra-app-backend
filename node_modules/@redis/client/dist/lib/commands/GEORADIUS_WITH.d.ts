...
declare const _default: {
    ...
    readonly transformReply: (this: void, reply: import("../RESP/types").TuplesReply<[import("../RESP/types").BlobStringReply<string>, ...any[]]>[], replyWith: GeoReplyWith[], typeMapping?: import("../RESP/types").TypeMapping | undefined) => import("./GEOSEARCH_WITH").GeoReplyWithMember[];
};

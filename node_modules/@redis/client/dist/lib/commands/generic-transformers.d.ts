...
import { RequestPolicyWithDefaults, ResponsePolicyWithDefaults } from '../command-metadata/policies-constants';
...
export type CommandReply = {
    ...
    policies: {
        request: RequestPolicyWithDefaults | undefined;
        response: ResponsePolicyWithDefaults | undefined;
    };
    isKeyless: boolean;
    /**
 ...
 */
export declare function transformKeySpec(raw: unknown): KeySpec;
export declare function transformCommandReply(this: void, [name, arity, flags, firstKeyIndex, lastKeyIndex, step, categories, tips, keySpecifications, subcommandsReply]: CommandRawReply): CommandReply;
...
export declare function transformRedisJsonReply(json: BlobStringReply, reviver?: JsonReviver): RedisJSON;
export declare function transformRedisJsonNullReply(json: NullReply | BlobStringReply, reviver?: JsonReviver): NullReply | RedisJSON;
export {};

...
class RedisClientPool extends node_events_1.EventEmitter {
    ...
    constructor(clientOptions, options) {
        ...
        clientOptions = { ...clientOptions, himportRegistry: new registry_1.FieldsetRegistry() };
            ...
            if (!client) {
                ...
                if (this._self.#options.acquireTimeout > 0) {
                    timeout = setTimeout(() => {
                        ...
                        reject(new errors_1.TimeoutError(`Timeout waiting for a client after ${this._self.#options.acquireTimeout}ms`));
    ...
    MULTI() {
        ...
        return new this.Multi((commands, selectedDB) => this.execute(client => client._executeMulti(commands, selectedDB)), commands => this.execute(client => client._executePipeline(commands)), this._commandOptions?.typeMapping, this._self._keyPrefix);
    }
    multi = this.MULTI;
    async close() {

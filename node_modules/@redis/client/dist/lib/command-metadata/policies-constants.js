...
exports.defaultCommandPolicies = exports.RESPONSE_POLICIES_WITH_DEFAULTS = exports.REQUEST_POLICIES_WITH_DEFAULTS = void 0;
exports.REQUEST_POLICIES_WITH_DEFAULTS = {
    /**
...
exports.RESPONSE_POLICIES_WITH_DEFAULTS = {
    /**
 ...
 */
function defaultCommandPolicies(isKeyless) {
    return isKeyless
        ? { request: exports.REQUEST_POLICIES_WITH_DEFAULTS.DEFAULT_KEYLESS, response: exports.RESPONSE_POLICIES_WITH_DEFAULTS.DEFAULT_KEYLESS, isKeyless: true }
        : { request: exports.REQUEST_POLICIES_WITH_DEFAULTS.DEFAULT_KEYED, response: exports.RESPONSE_POLICIES_WITH_DEFAULTS.DEFAULT_KEYED, isKeyless: false };
}
exports.defaultCommandPolicies = defaultCommandPolicies;
//# sourceMappingURL=policies-constants.js.map
...
declare const _default: {
    ...
    readonly INFO_DEBUG: {
        ...
        readonly transformReply: {
            ...
            readonly 3: (reply: import("@redis/client/dist/lib/RESP/types").ReplyUnion, preserve?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("./INFO_DEBUG").InfoDebugReply;
        };
    };
    /**
     * Gets debug information about a time series
    ...
    readonly INFO: {
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, key: string) => void;
        readonly transformReply: {
            readonly 2: (reply: import("./INFO").InfoRawReply, _: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("./INFO").InfoReply;
            readonly 3: (reply: import("@redis/client/dist/lib/RESP/types").ReplyUnion, preserve?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("./INFO").InfoReply;
        };
    };
    /**
     * Gets information about a time series
    ...
    readonly MRANGE_GROUPBY: {
        ...
        readonly transformReply: {
            readonly 2: (this: void, reply: import("./MRANGE_GROUPBY").TsMRangeGroupByRawReply2, _?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                samples: {
                    timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                    value: number;
                }[];
    ...
    readonly MRANGE_MULTIAGGR: {
        readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options: import("./RANGE_MULTIAGGR").TsMRangeMultiAggrOptions) => void;
        readonly transformReply: {
            readonly 2: (this: void, reply: import("./MRANGE_MULTIAGGR").TsMRangeMultiRawReply2, _?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                values: number[];
            }[]>;
            readonly 3: (this: void, reply: import("./MRANGE_MULTIAGGR").TsMRangeMultiRawReply3) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
    ...
    readonly MRANGE_SELECTED_LABELS_MULTIAGGR: {
        readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, selectedLabels: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options: import("./RANGE_MULTIAGGR").TsMRangeMultiAggrOptions) => void;
        readonly transformReply: {
    ...
    readonly MRANGE_SELECTED_LABELS: {
        readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, selectedLabels: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options?: import("./RANGE").TsMRangeOptions | undefined) => void;
        readonly transformReply: {
            readonly 2: (this: void, reply: import("./MRANGE_SELECTED_LABELS").TsMRangeSelectedLabelsRawReply2, _?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                labels: import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, import("@redis/client/dist/lib/RESP/types").NullReply | import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
                samples: {
    ...
    readonly MRANGE_WITHLABELS_MULTIAGGR: {
        readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options: import("./RANGE_MULTIAGGR").TsMRangeMultiAggrOptions) => void;
        readonly transformReply: {
            readonly 2: (this: void, reply: import("./MRANGE_WITHLABELS_MULTIAGGR").TsMRangeWithLabelsMultiRawReply2, _?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
            ...
            readonly 3: (this: void, reply: import("./MRANGE_WITHLABELS_MULTIAGGR").TsMRangeWithLabelsMultiRawReply3) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                labels: import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
                samples: {
                    timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                    values: import("@redis/client/dist/lib/RESP/types").DoubleReply<number>[];
    ...
    readonly MRANGE_WITHLABELS_GROUPBY: {
        readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, groupBy: import("./MRANGE_GROUPBY").TsMRangeGroupBy, options?: import("./RANGE").TsRangeOptions | undefined) => void;
        readonly transformReply: {
            readonly 2: (this: void, reply: import("./MRANGE_WITHLABELS_GROUPBY").TsMRangeWithLabelsGroupByRawReply2, _?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                labels: import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
    ...
    readonly MRANGE_WITHLABELS: {
        readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options?: import("./RANGE").TsMRangeOptions | undefined) => void;
        readonly transformReply: {
    ...
    readonly MRANGE: {
        ...
        readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options?: import("./RANGE").TsMRangeOptions | undefined) => void;
        readonly transformReply: {
            readonly 2: (this: void, reply: import("./MRANGE").TsMRangeRawReply2, _?: unknown, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                value: number;
            }[]>; /**
             * Creates or appends a sample to a time series
    ...
    readonly QUERYLABELS: {
        ...
        readonly IS_READ_ONLY: true;
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, filter?: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument | undefined) => void;
        readonly transformReply: {
            readonly 2: () => import("@redis/client/dist/lib/RESP/types").ArrayReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
            readonly 3: () => import("@redis/client/dist/lib/RESP/types").SetReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
        };
     ...
     * @param filter - Optional filter expression(s) (same language as `TS.QUERYINDEX`); omit to query all indexed series
     */
    readonly QUERYLABELS_VALUES: {
        readonly NOT_KEYED_COMMAND: true;
        readonly IS_READ_ONLY: true;
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, label: import("@redis/client/dist/lib/RESP/types").RedisArgument, filter?: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument | undefined) => void;
        readonly transformReply: {
            readonly 2: () => import("@redis/client/dist/lib/RESP/types").ArrayReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
            readonly 3: () => import("@redis/client/dist/lib/RESP/types").SetReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
        };
     ...
     */
    readonly READ: {
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, key: import("@redis/client/dist/lib/RESP/types").RedisArgument, timestamp: import("./READ").TsReadTimestamp, options?: import("./READ").TsReadOptions | undefined) => void;
        readonly transformReply: {
    ...
    readonly RANGE_MULTIAGGR: {
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, key: import("@redis/client/dist/lib/RESP/types").RedisArgument, fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, options: import("./RANGE_MULTIAGGR").TsRangeMultiAggrOptions) => void;
        readonly transformReply: {
            readonly 2: (this: void, reply: import("@redis/client/dist/lib/RESP/types").RespType<42, import("@redis/client/dist/lib/RESP/types").RespType<42, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, ...import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]], never, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, ...import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]]>[], never, import("@redis/client/dist/lib/RESP/types").RespType<42, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, ...import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]], never, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, ...import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]]>[]>) => {
                timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                values: number[];
            }[];
            readonly 3: (this: void, reply: import("./helpers").MultiAggregationSamplesRawReply) => {
                timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                values: import("@redis/client/dist/lib/RESP/types").DoubleReply<number>[];
            }[];
        };
    ...
    readonly NRANGE: {
        readonly IS_READ_ONLY: true;
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, keys: import("@redis/client/dist/lib/RESP/types").RedisArgument[], fromTimestamp: import("./helpers").Timestamp, toTimestamp: import("./helpers").Timestamp, options?: import("./NRANGE").TsNRangeOptions | undefined) => void;
        readonly transformReply: {
            2(reply: import("@redis/client/dist/lib/RESP/types").RespType<42, import("@redis/client/dist/lib/RESP/types").RespType<42, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, import("@redis/client/dist/lib/RESP/types").RespType<42, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[], never, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]>], never, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, import("@redis/client/dist/lib/RESP/types").RespType<42, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[], never, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]>]>[], never, import("@redis/client/dist/lib/RESP/types").RespType<42, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, import("@redis/client/dist/lib/RESP/types").RespType<42, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[], never, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]>], never, [import("@redis/client/dist/lib/RESP/types").NumberReply<number>, import("@redis/client/dist/lib/RESP/types").RespType<42, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[], never, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[]>]>[]>): {
                timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                values: number[];
            }[];
            3(reply: import("./helpers").PivotSamplesRawReply): {
                timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                values: import("@redis/client/dist/lib/RESP/types").ArrayReply<import("@redis/client/dist/lib/RESP/types").DoubleReply<number>>;
            }[];
        };
    };
    /**

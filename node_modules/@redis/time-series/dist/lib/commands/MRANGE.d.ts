 ...
 */
export declare function createTransformMRangeArguments(command: RedisArgument): (parser: CommandParser, fromTimestamp: Timestamp, toTimestamp: Timestamp, filter: RedisVariadicArgument, options?: TsMRangeOptions) => void;
declare const _default: {
    ...
    readonly transformReply: {
        readonly 2: (this: void, reply: TsMRangeRawReply2, _?: unknown, typeMapping?: TypeMapping) => MapReply<BlobStringReply<string>, {

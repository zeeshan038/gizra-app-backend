...
import { RedisArgument, ArrayReply, TuplesReply, BlobStringReply, NumberReply, DoubleReply, UnwrapReply, TypeMapping } from '../RESP/types';
...
declare const _default: {
    ...
    readonly transformReply: (this: void, reply: UnwrapReply<ArrayReply<TuplesReply<[BlobStringReply, ...Array<any>]>>>, replyWith: Array<GeoReplyWith>, typeMapping?: TypeMapping) => GeoReplyWithMember[];
};
